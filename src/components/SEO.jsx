...
const Head = props => {
  ...
  return (
    <Helmet>
      ...
      <title>{title}</title>
      <link rel="apple-touch-icon" href="/favicons/favicon.jpg" />
      <link rel="icon" type="image/png" sizes="32x32" href="/favicons/favicon.jpg" />
      <link rel="icon" type="image/png" sizes="16x16" href="/favicons/favicon.jpg" />
